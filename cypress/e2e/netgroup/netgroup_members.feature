Feature: Netgroup members manipulation
  ...
  Scenario: Seed data
    Given netgroup "mynetgroup" exists
    And user "admin" exists in table "mynetgroup/member_user"
  ...
  Scenario: Seed data
    Given netgroup "mynetgroup" exists
    And user group "editors" exists in table "mynetgroup/member_group"
  ...
  Scenario: Add a Host member
    ...
    Then I should not see "member-of-add-modal" modal
    And I should see "add-member-success" alert
    When I search for "server.ipa.demo" in the data table
  ...
  Scenario: Seed data
    Given netgroup "mynetgroup" exists
    And host "server.ipa.demo" exists in table "mynetgroup/member_host"
  ...
  Scenario: Remove Host member
    ...
    When I select entry "server.ipa.demo" in the data table
    And I click on the "member-of-button-delete" button
    Then I should see "member-of-delete-modal" modal
  ...
  Scenario: Add a Host group member
    ...
    Then I should not see "member-of-add-modal" modal
    And I should see "add-member-success" alert
    When I search for "ipaservers" in the data table
  ...
  Scenario: Seed data
    Given netgroup "mynetgroup" exists
    And hostgroup "ipaservers" exists in table "mynetgroup/member_hostgroup"
  ...
  Scenario: Add a Netgroup member
    ...
    Then I should not see "member-of-add-modal" modal
    And I should see "add-member-success" alert
    When I search for "mynetgroup2" in the data table
  ...
  Scenario: Seed data
    Given netgroup "mynetgroup" exists
    And netgroup "mynetgroup2" exists
    And netgroup "mynetgroup2" exists in table "mynetgroup/member_netgroup"
